...
from .MOBO import MultiObjectiveBOAdvisor, create_multi_objective_advisor  # 新增
...
_ADVISOR_REGISTRY = {
    'bo': BO,
    'mfbo': MFBO,
    'mobo': MultiObjectiveBOAdvisor,  # 新增
}
...
__all__ = [
    'BO',
    'MFBO',
    'MultiObjectiveBOAdvisor',  # 新增
    'create_multi_objective_advisor',  # 新增
    'AdvisorConfig',
    'get_advisor_config',
    'get_advisor',
    'get_surrogate_type',
